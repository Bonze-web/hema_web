<template>
    <div class="table-index" style="background:#fff">
        ...
        <div>
            <el-table :data="productList" tooltip-effect="dark" :row-key="getRowKeys" style="width: 100%" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    getProduct: function() {
      DemolitionAndService.query(this.page, this.pageSize, this.form)
      .then((res) => {
