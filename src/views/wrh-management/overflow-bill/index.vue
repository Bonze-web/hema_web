      ...
      <div class="select-head">
            <el-form ref="form" style="display:flex;flex-wrap:wrap" :model="form" label-width="80px" label-position="right">
                ...
                <el-form-item label="货位">
                    <el-input type='text' clearable placeholder="请输入货位编号" v-model="form.binCodeEquals" class="input-width"></el-input>
                </el-form-item>
        ...
        <div style="background:#fff;">
          ...
          <el-table
            ...
            >
                ...
                <el-table-column prop="billTypeName" label="溢余类型"></el-table-column>
                <!-- <el-table-column prop="wrhCode" label="仓区">
                  <template slot-scope="scope">
                    {{ '[' + scope.row.wrhCode + ']' + scope.row.wrhName }}
                  </template>
                </el-table-column> -->
                <el-table-column prop="incerName" label="报溢员">
                  <template slot-scope="scope">
                    {{ scope.row.incerName }}
                  </template>
                </el-table-column>
