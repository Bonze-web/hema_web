    ...
    <div>
        <div class="head" v-if="status === 'create' || status === 'edit'">
            ...
            <div>
                ...
                <el-button type="primary" @click="createSuppliers"  v-if="hasPermission(PermIds.WMS_DOCK_UPDATE)">确认</el-button>
        ...
        <div class="head" v-if="status === 'read'">
            ...
            <div>
                ...
                <el-button type="primary" v-if="hasPermission(PermIds.WMS_DOCK_UPDATE)"  @click="editSupplier">编辑</el-button>
            </div>
        </div>
